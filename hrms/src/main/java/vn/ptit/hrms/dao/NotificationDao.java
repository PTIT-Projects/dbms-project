...
public class NotificationDao {
    ...
    public void createNotification(Notification notification) {
        String sql = "INSERT INTO notifications (title, content, created_date, created_by) VALUES (?, ?, ?, ?)";
        jdbcTemplate.update(sql,
                notification.getTitle(),
                notification.getContent(),
                notification.getCreatedDate() != null ? java.sql.Timestamp.valueOf(notification.getCreatedDate()) : null,
    ...
    public void updateNotification(Notification notification) {
        String sql = "UPDATE notifications SET title = ?, content = ?, created_date = ?, created_by = ? WHERE id = ?";
        jdbcTemplate.update(sql,
                notification.getTitle(),
                notification.getContent(),
                notification.getCreatedDate() != null ? java.sql.Timestamp.valueOf(notification.getCreatedDate()) : null,
