...
@Repository
public class DemographicAnalysisDao {
    private final JdbcTemplate jdbcTemplate;

    public DemographicAnalysisDao(@Qualifier("warehouseJdbcTemplate") JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    // 9.a Phân tích lương theo giới tính và theo độ tuổi
    public List<SalaryByAgeGenderDTO> getSalaryByDemographics() {
        String sql = """
    ...
    public List<RewardByGenderDTO> getRewardsByGender() {
        String sql = """
            SELECT 
                e.gender,
    ...
    public List<AvgAgeByDepartmentDTO> getAverageAgeByDepartment() {
        String sql = """
            SELECT 
                e.department_name,
    ...
    public List<ResignationByAgeDTO> getResignationRateByAge() {
        String sql = """
            SELECT
                CASE
